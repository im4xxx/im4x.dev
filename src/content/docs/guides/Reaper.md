...
### **3 СПОСОБ - Обработка вокальных треков в отдельном проекте**

Этот способ хорошо показал себя на сложных, загруженных проектах. Суть проста: делим работу на 2 этапа и 2 риперовских проекта, в первом делаем всю обработку (в т.ч. групповую), Во втором проекте делаем укладку реплик, расставляем эффекты и прочее.
